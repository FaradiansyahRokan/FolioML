    ...
    <div className="min-h-screen bg-white font-sans text-zinc-900">
      ...
      <header className="h-[64px] flex items-center justify-between px-6 border-b border-zinc-100">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xl font-medium tracking-tight text-zinc-800 flex items-center gap-2">
            FolioML <span className="text-[10px] bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full font-semibold uppercase tracking-wider">v3.0</span>
          </span>
        </div>
      ...
      <main className="max-w-[1200px] mx-auto px-6 py-8">
        ...
        {/* Banner Vibe Coding */}
        <div className="mb-8 p-6 rounded-3xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold text-indigo-950 flex items-center gap-2">
              Selamat datang di FolioML ✨
            </h1>
            <p className="text-sm text-indigo-800/80 mt-1">
              Platform AI Knowledge OS untuk riset, dokumen, dan analisis berbasis RAG.
            </p>
          </div>
          <div className="flex items-center gap-2 self-start md:self-auto">
            <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></span>
            <span className="text-xs font-medium text-emerald-800 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">
              Vibe Coding Active
            </span>
          </div>
        </div>
